/**
 * @file signature_validator.js
 * Ed25519 and ECDSA request signature validator.
...
export class SignatureValidator extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'SignatureValidator';
  ...
  /**
   * Domain method #1 for SignatureValidator.
  ...
  /**
   * Domain method #2 for SignatureValidator.
  ...
  /**
   * Domain method #3 for SignatureValidator.
  ...
  /**
   * Domain method #4 for SignatureValidator.
  ...
  /**
   * Domain method #5 for SignatureValidator.
  ...
  /**
   * Domain method #6 for SignatureValidator.
  ...
  /**
   * Domain method #7 for SignatureValidator.
  ...
  /**
   * Domain method #8 for SignatureValidator.
  ...
  /**
   * Domain method #9 for SignatureValidator.
  ...
  /**
   * Domain method #10 for SignatureValidator.
  ...
  /**
   * Domain method #11 for SignatureValidator.
  ...
  /**
   * Domain method #12 for SignatureValidator.
  ...
  /**
   * Domain method #13 for SignatureValidator.
  ...
  /**
   * Domain method #14 for SignatureValidator.
  ...
  /**
   * Domain method #15 for SignatureValidator.
