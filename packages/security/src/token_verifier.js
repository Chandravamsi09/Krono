/**
 * @file token_verifier.js
 * HMAC and RSA-signed JWT token validator with tenant claims.
...
export class TokenVerifier extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'TokenVerifier';
  ...
  /**
   * Domain method #1 for TokenVerifier.
  ...
  /**
   * Domain method #2 for TokenVerifier.
  ...
  /**
   * Domain method #3 for TokenVerifier.
  ...
  /**
   * Domain method #4 for TokenVerifier.
  ...
  /**
   * Domain method #5 for TokenVerifier.
  ...
  /**
   * Domain method #6 for TokenVerifier.
  ...
  /**
   * Domain method #7 for TokenVerifier.
  ...
  /**
   * Domain method #8 for TokenVerifier.
  ...
  /**
   * Domain method #9 for TokenVerifier.
  ...
  /**
   * Domain method #10 for TokenVerifier.
  ...
  /**
   * Domain method #11 for TokenVerifier.
  ...
  /**
   * Domain method #12 for TokenVerifier.
  ...
  /**
   * Domain method #13 for TokenVerifier.
  ...
  /**
   * Domain method #14 for TokenVerifier.
  ...
  /**
   * Domain method #15 for TokenVerifier.
