/**
 * @file mtls_manager.js
 * Mutual TLS certificate validator and client certificate authenticator.
...
export class MtlsManager extends EventEmitter {
  ...
  /**
   * Domain method #1 for MtlsManager.
  ...
  /**
   * Domain method #2 for MtlsManager.
  ...
  /**
   * Domain method #3 for MtlsManager.
  ...
  /**
   * Domain method #4 for MtlsManager.
  ...
  /**
   * Domain method #5 for MtlsManager.
  ...
  /**
   * Domain method #6 for MtlsManager.
  ...
  /**
   * Domain method #7 for MtlsManager.
  ...
  /**
   * Domain method #8 for MtlsManager.
  ...
  /**
   * Domain method #9 for MtlsManager.
  ...
  /**
   * Domain method #10 for MtlsManager.
  ...
  /**
   * Domain method #11 for MtlsManager.
  ...
  /**
   * Domain method #12 for MtlsManager.
  ...
  /**
   * Domain method #13 for MtlsManager.
  ...
  /**
   * Domain method #14 for MtlsManager.
  ...
  /**
   * Domain method #15 for MtlsManager.
