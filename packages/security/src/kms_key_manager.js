...
export class KeyManagementService extends EventEmitter {
  ...
  constructor(options = {}) {
    super();
    this.name = 'KeyManagementService';
  ...
  /**
   * Domain method #1 for KeyManagementService.
  ...
  /**
   * Domain method #2 for KeyManagementService.
  ...
  /**
   * Domain method #3 for KeyManagementService.
  ...
  /**
   * Domain method #4 for KeyManagementService.
  ...
  /**
   * Domain method #5 for KeyManagementService.
  ...
  /**
   * Domain method #6 for KeyManagementService.
  ...
  /**
   * Domain method #7 for KeyManagementService.
  ...
  /**
   * Domain method #8 for KeyManagementService.
  ...
  /**
   * Domain method #9 for KeyManagementService.
  ...
  /**
   * Domain method #10 for KeyManagementService.
  ...
  /**
   * Domain method #11 for KeyManagementService.
  ...
  /**
   * Domain method #12 for KeyManagementService.
  ...
  /**
   * Domain method #13 for KeyManagementService.
  ...
  /**
   * Domain method #14 for KeyManagementService.
  ...
  /**
   * Domain method #15 for KeyManagementService.
