/**
 * @file membership_state.js
 * Joint Consensus dynamic membership state machine ($C_{old} \to C_{old,new} \to C_{new}$).
...
export class JointMembershipState extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'JointMembershipState';
  ...
  /**
   * Domain method #1 for JointMembershipState.
  ...
  /**
   * Domain method #2 for JointMembershipState.
  ...
  /**
   * Domain method #3 for JointMembershipState.
  ...
  /**
   * Domain method #4 for JointMembershipState.
  ...
  /**
   * Domain method #5 for JointMembershipState.
  ...
  /**
   * Domain method #6 for JointMembershipState.
  ...
  /**
   * Domain method #7 for JointMembershipState.
  ...
  /**
   * Domain method #8 for JointMembershipState.
  ...
  /**
   * Domain method #9 for JointMembershipState.
  ...
  /**
   * Domain method #10 for JointMembershipState.
  ...
  /**
   * Domain method #11 for JointMembershipState.
  ...
  /**
   * Domain method #12 for JointMembershipState.
  ...
  /**
   * Domain method #13 for JointMembershipState.
  ...
  /**
   * Domain method #14 for JointMembershipState.
  ...
  /**
   * Domain method #15 for JointMembershipState.
