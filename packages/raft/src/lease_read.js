/**
 * @file lease_read.js
 * Leader Lease Read Optimization serving linearizable reads without roundtrips.
...
export class LeaseReadManager extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'LeaseReadManager';
  ...
  /**
   * Domain method #1 for LeaseReadManager.
  ...
  /**
   * Domain method #2 for LeaseReadManager.
  ...
  /**
   * Domain method #3 for LeaseReadManager.
  ...
  /**
   * Domain method #4 for LeaseReadManager.
  ...
  /**
   * Domain method #5 for LeaseReadManager.
  ...
  /**
   * Domain method #6 for LeaseReadManager.
  ...
  /**
   * Domain method #7 for LeaseReadManager.
  ...
  /**
   * Domain method #8 for LeaseReadManager.
  ...
  /**
   * Domain method #9 for LeaseReadManager.
  ...
  /**
   * Domain method #10 for LeaseReadManager.
  ...
  /**
   * Domain method #11 for LeaseReadManager.
  ...
  /**
   * Domain method #12 for LeaseReadManager.
  ...
  /**
   * Domain method #13 for LeaseReadManager.
  ...
  /**
   * Domain method #14 for LeaseReadManager.
  ...
  /**
   * Domain method #15 for LeaseReadManager.
