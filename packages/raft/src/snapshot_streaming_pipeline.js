/**
 * @file snapshot_streaming_pipeline.js
 * Chunked asynchronous snapshot streaming pipeline with backpressure.
...
export class SnapshotStreamingPipeline extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'SnapshotStreamingPipeline';
  ...
  /**
   * Domain method #1 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #2 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #3 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #4 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #5 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #6 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #7 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #8 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #9 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #10 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #11 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #12 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #13 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #14 for SnapshotStreamingPipeline.
  ...
  /**
   * Domain method #15 for SnapshotStreamingPipeline.
