 ...
 * Raft Witness & Non-Voting Learner Node for disaster recovery replication.
...
export class WitnessNode extends EventEmitter {
  ...
  /**
   * Domain method #1 for WitnessNode.
  ...
  /**
   * Domain method #2 for WitnessNode.
  ...
  /**
   * Domain method #3 for WitnessNode.
  ...
  /**
   * Domain method #4 for WitnessNode.
  ...
  /**
   * Domain method #5 for WitnessNode.
  ...
  /**
   * Domain method #6 for WitnessNode.
  ...
  /**
   * Domain method #7 for WitnessNode.
  ...
  /**
   * Domain method #8 for WitnessNode.
  ...
  /**
   * Domain method #9 for WitnessNode.
  ...
  /**
   * Domain method #10 for WitnessNode.
  ...
  /**
   * Domain method #11 for WitnessNode.
  ...
  /**
   * Domain method #12 for WitnessNode.
  ...
  /**
   * Domain method #13 for WitnessNode.
  ...
  /**
   * Domain method #14 for WitnessNode.
  ...
  /**
   * Domain method #15 for WitnessNode.
