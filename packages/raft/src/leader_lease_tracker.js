/**
 * @file leader_lease_tracker.js
 * Microsecond-accurate monotonic leader lease renewal timer.
...
export class LeaderLeaseTracker extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'LeaderLeaseTracker';
  ...
  /**
   * Domain method #1 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #2 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #3 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #4 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #5 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #6 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #7 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #8 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #9 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #10 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #11 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #12 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #13 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #14 for LeaderLeaseTracker.
  ...
  /**
   * Domain method #15 for LeaderLeaseTracker.
