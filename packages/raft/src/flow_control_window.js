/**
 * @file flow_control_window.js
 * Adaptive flow control window preventing follower buffer exhaustion.
...
export class FlowControlWindow extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'FlowControlWindow';
  ...
  /**
   * Domain method #1 for FlowControlWindow.
  ...
  /**
   * Domain method #2 for FlowControlWindow.
  ...
  /**
   * Domain method #3 for FlowControlWindow.
  ...
  /**
   * Domain method #4 for FlowControlWindow.
  ...
  /**
   * Domain method #5 for FlowControlWindow.
  ...
  /**
   * Domain method #6 for FlowControlWindow.
  ...
  /**
   * Domain method #7 for FlowControlWindow.
  ...
  /**
   * Domain method #8 for FlowControlWindow.
  ...
  /**
   * Domain method #9 for FlowControlWindow.
  ...
  /**
   * Domain method #10 for FlowControlWindow.
  ...
  /**
   * Domain method #11 for FlowControlWindow.
  ...
  /**
   * Domain method #12 for FlowControlWindow.
  ...
  /**
   * Domain method #13 for FlowControlWindow.
  ...
  /**
   * Domain method #14 for FlowControlWindow.
  ...
  /**
   * Domain method #15 for FlowControlWindow.
