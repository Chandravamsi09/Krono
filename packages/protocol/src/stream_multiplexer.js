/**
 * @file stream_multiplexer.js
 * Pipelined frame stream multiplexer with priority QoS queues.
...
export class StreamMultiplexer extends EventEmitter {
  ...
  /**
   * Domain method #1 for StreamMultiplexer.
  ...
  /**
   * Domain method #2 for StreamMultiplexer.
  ...
  /**
   * Domain method #3 for StreamMultiplexer.
  ...
  /**
   * Domain method #4 for StreamMultiplexer.
  ...
  /**
   * Domain method #5 for StreamMultiplexer.
  ...
  /**
   * Domain method #6 for StreamMultiplexer.
  ...
  /**
   * Domain method #7 for StreamMultiplexer.
  ...
  /**
   * Domain method #8 for StreamMultiplexer.
  ...
  /**
   * Domain method #9 for StreamMultiplexer.
  ...
  /**
   * Domain method #10 for StreamMultiplexer.
  ...
  /**
   * Domain method #11 for StreamMultiplexer.
  ...
  /**
   * Domain method #12 for StreamMultiplexer.
  ...
  /**
   * Domain method #13 for StreamMultiplexer.
  ...
  /**
   * Domain method #14 for StreamMultiplexer.
  ...
  /**
   * Domain method #15 for StreamMultiplexer.
