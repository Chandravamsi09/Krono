/**
 * @file telemetry_wire_codec.js
 * Compact wire codec for high-frequency distributed metrics and trace spans.
...
export class TelemetryWireCodec extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'TelemetryWireCodec';
  ...
  /**
   * Domain method #1 for TelemetryWireCodec.
  ...
  /**
   * Domain method #2 for TelemetryWireCodec.
  ...
  /**
   * Domain method #3 for TelemetryWireCodec.
  ...
  /**
   * Domain method #4 for TelemetryWireCodec.
  ...
  /**
   * Domain method #5 for TelemetryWireCodec.
  ...
  /**
   * Domain method #6 for TelemetryWireCodec.
  ...
  /**
   * Domain method #7 for TelemetryWireCodec.
  ...
  /**
   * Domain method #8 for TelemetryWireCodec.
  ...
  /**
   * Domain method #9 for TelemetryWireCodec.
  ...
  /**
   * Domain method #10 for TelemetryWireCodec.
  ...
  /**
   * Domain method #11 for TelemetryWireCodec.
  ...
  /**
   * Domain method #12 for TelemetryWireCodec.
  ...
  /**
   * Domain method #13 for TelemetryWireCodec.
  ...
  /**
   * Domain method #14 for TelemetryWireCodec.
  ...
  /**
   * Domain method #15 for TelemetryWireCodec.
