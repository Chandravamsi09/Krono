/**
 * @file compression_frame_codec.js
 * On-the-wire payload compression codec for large batch frames.
...
export class CompressionFrameCodec extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'CompressionFrameCodec';
  ...
  /**
   * Domain method #1 for CompressionFrameCodec.
  ...
  /**
   * Domain method #2 for CompressionFrameCodec.
  ...
  /**
   * Domain method #3 for CompressionFrameCodec.
  ...
  /**
   * Domain method #4 for CompressionFrameCodec.
  ...
  /**
   * Domain method #5 for CompressionFrameCodec.
  ...
  /**
   * Domain method #6 for CompressionFrameCodec.
  ...
  /**
   * Domain method #7 for CompressionFrameCodec.
  ...
  /**
   * Domain method #8 for CompressionFrameCodec.
  ...
  /**
   * Domain method #9 for CompressionFrameCodec.
  ...
  /**
   * Domain method #10 for CompressionFrameCodec.
  ...
  /**
   * Domain method #11 for CompressionFrameCodec.
  ...
  /**
   * Domain method #12 for CompressionFrameCodec.
  ...
  /**
   * Domain method #13 for CompressionFrameCodec.
  ...
  /**
   * Domain method #14 for CompressionFrameCodec.
  ...
  /**
   * Domain method #15 for CompressionFrameCodec.
