/**
 * @file schema_registry.js
 * Schema evolution validator checking BACKWARD, FORWARD, and FULL compatibility.
...
export class SchemaRegistry extends EventEmitter {
  ...
  /**
   * Domain method #1 for SchemaRegistry.
  ...
  /**
   * Domain method #2 for SchemaRegistry.
  ...
  /**
   * Domain method #3 for SchemaRegistry.
  ...
  /**
   * Domain method #4 for SchemaRegistry.
  ...
  /**
   * Domain method #5 for SchemaRegistry.
  ...
  /**
   * Domain method #6 for SchemaRegistry.
  ...
  /**
   * Domain method #7 for SchemaRegistry.
  ...
  /**
   * Domain method #8 for SchemaRegistry.
  ...
  /**
   * Domain method #9 for SchemaRegistry.
  ...
  /**
   * Domain method #10 for SchemaRegistry.
  ...
  /**
   * Domain method #11 for SchemaRegistry.
  ...
  /**
   * Domain method #12 for SchemaRegistry.
  ...
  /**
   * Domain method #13 for SchemaRegistry.
  ...
  /**
   * Domain method #14 for SchemaRegistry.
  ...
  /**
   * Domain method #15 for SchemaRegistry.
