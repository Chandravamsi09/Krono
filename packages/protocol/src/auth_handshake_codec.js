/**
 * @file auth_handshake_codec.js
 * Cryptographic authentication handshake and mutual challenge-response codec.
...
export class AuthHandshakeCodec extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'AuthHandshakeCodec';
  ...
  /**
   * Domain method #1 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #2 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #3 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #4 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #5 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #6 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #7 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #8 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #9 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #10 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #11 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #12 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #13 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #14 for AuthHandshakeCodec.
  ...
  /**
   * Domain method #15 for AuthHandshakeCodec.
