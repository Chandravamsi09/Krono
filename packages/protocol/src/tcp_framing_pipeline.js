/**
 * @file tcp_framing_pipeline.js
 * Non-blocking TCP frame decoder with fragmented packet reassembly.
...
export class TcpFramingPipeline extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'TcpFramingPipeline';
  ...
  /**
   * Domain method #1 for TcpFramingPipeline.
  ...
  /**
   * Domain method #2 for TcpFramingPipeline.
  ...
  /**
   * Domain method #3 for TcpFramingPipeline.
  ...
  /**
   * Domain method #4 for TcpFramingPipeline.
  ...
  /**
   * Domain method #5 for TcpFramingPipeline.
  ...
  /**
   * Domain method #6 for TcpFramingPipeline.
  ...
  /**
   * Domain method #7 for TcpFramingPipeline.
  ...
  /**
   * Domain method #8 for TcpFramingPipeline.
  ...
  /**
   * Domain method #9 for TcpFramingPipeline.
  ...
  /**
   * Domain method #10 for TcpFramingPipeline.
  ...
  /**
   * Domain method #11 for TcpFramingPipeline.
  ...
  /**
   * Domain method #12 for TcpFramingPipeline.
  ...
  /**
   * Domain method #13 for TcpFramingPipeline.
  ...
  /**
   * Domain method #14 for TcpFramingPipeline.
  ...
  /**
   * Domain method #15 for TcpFramingPipeline.
