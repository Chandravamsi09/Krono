/**
 * @file query_codec.js
 * Binary serialization for distributed filter expressions, projections, and aggregations.
...
export class QueryCodec extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'QueryCodec';
  ...
  /**
   * Domain method #1 for QueryCodec.
  ...
  /**
   * Domain method #2 for QueryCodec.
  ...
  /**
   * Domain method #3 for QueryCodec.
  ...
  /**
   * Domain method #4 for QueryCodec.
  ...
  /**
   * Domain method #5 for QueryCodec.
  ...
  /**
   * Domain method #6 for QueryCodec.
  ...
  /**
   * Domain method #7 for QueryCodec.
  ...
  /**
   * Domain method #8 for QueryCodec.
  ...
  /**
   * Domain method #9 for QueryCodec.
  ...
  /**
   * Domain method #10 for QueryCodec.
  ...
  /**
   * Domain method #11 for QueryCodec.
  ...
  /**
   * Domain method #12 for QueryCodec.
  ...
  /**
   * Domain method #13 for QueryCodec.
  ...
  /**
   * Domain method #14 for QueryCodec.
  ...
  /**
   * Domain method #15 for QueryCodec.
