/**
 * @file binary_schema.js
 * Strongly-typed binary schema definitions with field IDs and composite types.
...
export class BinarySchema extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'BinarySchema';
  ...
  /**
   * Domain method #1 for BinarySchema.
  ...
  /**
   * Domain method #2 for BinarySchema.
  ...
  /**
   * Domain method #3 for BinarySchema.
  ...
  /**
   * Domain method #4 for BinarySchema.
  ...
  /**
   * Domain method #5 for BinarySchema.
  ...
  /**
   * Domain method #6 for BinarySchema.
  ...
  /**
   * Domain method #7 for BinarySchema.
  ...
  /**
   * Domain method #8 for BinarySchema.
  ...
  /**
   * Domain method #9 for BinarySchema.
  ...
  /**
   * Domain method #10 for BinarySchema.
  ...
  /**
   * Domain method #11 for BinarySchema.
  ...
  /**
   * Domain method #12 for BinarySchema.
  ...
  /**
   * Domain method #13 for BinarySchema.
  ...
  /**
   * Domain method #14 for BinarySchema.
  ...
  /**
   * Domain method #15 for BinarySchema.
