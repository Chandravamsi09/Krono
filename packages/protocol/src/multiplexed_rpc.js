/**
 * @file multiplexed_rpc.js
 * Full-duplex connection multiplexer over single TCP sockets with flow control windows.
...
export class MultiplexedRpcEngine extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'MultiplexedRpcEngine';
  ...
  /**
   * Domain method #1 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #2 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #3 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #4 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #5 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #6 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #7 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #8 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #9 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #10 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #11 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #12 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #13 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #14 for MultiplexedRpcEngine.
  ...
  /**
   * Domain method #15 for MultiplexedRpcEngine.
