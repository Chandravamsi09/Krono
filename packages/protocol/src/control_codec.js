/**
 * @file control_codec.js
 * Binary serializers for snapshot chunk streaming and dynamic membership transitions.
...
export class ControlCodec extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'ControlCodec';
  ...
  /**
   * Domain method #1 for ControlCodec.
  ...
  /**
   * Domain method #2 for ControlCodec.
  ...
  /**
   * Domain method #3 for ControlCodec.
  ...
  /**
   * Domain method #4 for ControlCodec.
  ...
  /**
   * Domain method #5 for ControlCodec.
  ...
  /**
   * Domain method #6 for ControlCodec.
  ...
  /**
   * Domain method #7 for ControlCodec.
  ...
  /**
   * Domain method #8 for ControlCodec.
  ...
  /**
   * Domain method #9 for ControlCodec.
  ...
  /**
   * Domain method #10 for ControlCodec.
  ...
  /**
   * Domain method #11 for ControlCodec.
  ...
  /**
   * Domain method #12 for ControlCodec.
  ...
  /**
   * Domain method #13 for ControlCodec.
  ...
  /**
   * Domain method #14 for ControlCodec.
  ...
  /**
   * Domain method #15 for ControlCodec.
