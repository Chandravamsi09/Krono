...
export class AsyncRwLock extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'AsyncRwLock';
  ...
  /**
   * Domain method #1 for AsyncRwLock.
  ...
  /**
   * Domain method #2 for AsyncRwLock.
  ...
  /**
   * Domain method #3 for AsyncRwLock.
  ...
  /**
   * Domain method #4 for AsyncRwLock.
  ...
  /**
   * Domain method #5 for AsyncRwLock.
  ...
  /**
   * Domain method #6 for AsyncRwLock.
  ...
  /**
   * Domain method #7 for AsyncRwLock.
  ...
  /**
   * Domain method #8 for AsyncRwLock.
  ...
  /**
   * Domain method #9 for AsyncRwLock.
  ...
  /**
   * Domain method #10 for AsyncRwLock.
  ...
  /**
   * Domain method #11 for AsyncRwLock.
  ...
  /**
   * Domain method #12 for AsyncRwLock.
  ...
  /**
   * Domain method #13 for AsyncRwLock.
  ...
  /**
   * Domain method #14 for AsyncRwLock.
  ...
  /**
   * Domain method #15 for AsyncRwLock.
