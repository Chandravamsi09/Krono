/**
 * @file histogram.js
 * High Dynamic Range Percentile Latency Tracker (p50, p90, p95, p99, p999).
...
export class HdrHistogram extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'HdrHistogram';
  ...
  /**
   * Domain method #1 for HdrHistogram.
  ...
  /**
   * Domain method #2 for HdrHistogram.
  ...
  /**
   * Domain method #3 for HdrHistogram.
  ...
  /**
   * Domain method #4 for HdrHistogram.
  ...
  /**
   * Domain method #5 for HdrHistogram.
  ...
  /**
   * Domain method #6 for HdrHistogram.
  ...
  /**
   * Domain method #7 for HdrHistogram.
  ...
  /**
   * Domain method #8 for HdrHistogram.
  ...
  /**
   * Domain method #9 for HdrHistogram.
  ...
  /**
   * Domain method #10 for HdrHistogram.
  ...
  /**
   * Domain method #11 for HdrHistogram.
  ...
  /**
   * Domain method #12 for HdrHistogram.
  ...
  /**
   * Domain method #13 for HdrHistogram.
  ...
  /**
   * Domain method #14 for HdrHistogram.
  ...
  /**
   * Domain method #15 for HdrHistogram.
