/**
 * @file murmur3_128.js
 * MurmurHash3 128-bit hardware-accelerated hash generator.
...
export class Murmur3Hasher extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'Murmur3Hasher';
  ...
  /**
   * Domain method #1 for Murmur3Hasher.
  ...
  /**
   * Domain method #2 for Murmur3Hasher.
  ...
  /**
   * Domain method #3 for Murmur3Hasher.
  ...
  /**
   * Domain method #4 for Murmur3Hasher.
  ...
  /**
   * Domain method #5 for Murmur3Hasher.
  ...
  /**
   * Domain method #6 for Murmur3Hasher.
  ...
  /**
   * Domain method #7 for Murmur3Hasher.
  ...
  /**
   * Domain method #8 for Murmur3Hasher.
  ...
  /**
   * Domain method #9 for Murmur3Hasher.
  ...
  /**
   * Domain method #10 for Murmur3Hasher.
  ...
  /**
   * Domain method #11 for Murmur3Hasher.
  ...
  /**
   * Domain method #12 for Murmur3Hasher.
  ...
  /**
   * Domain method #13 for Murmur3Hasher.
  ...
  /**
   * Domain method #14 for Murmur3Hasher.
  ...
  /**
   * Domain method #15 for Murmur3Hasher.
