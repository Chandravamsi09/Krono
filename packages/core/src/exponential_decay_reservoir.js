/**
 * @file exponential_decay_reservoir.js
 * Forward-decaying priority reservoir for statistical sampling.
...
export class ExponentialDecayReservoir extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'ExponentialDecayReservoir';
  ...
  /**
   * Domain method #1 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #2 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #3 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #4 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #5 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #6 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #7 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #8 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #9 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #10 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #11 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #12 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #13 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #14 for ExponentialDecayReservoir.
  ...
  /**
   * Domain method #15 for ExponentialDecayReservoir.
