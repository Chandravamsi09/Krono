/**
 * @file arc_cache.js
 * Adaptive Replacement Cache (ARC) algorithm self-tuning between recency and frequency hits.
...
export class AdaptiveReplacementCache extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'AdaptiveReplacementCache';
  ...
  /**
   * Domain method #1 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #2 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #3 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #4 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #5 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #6 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #7 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #8 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #9 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #10 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #11 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #12 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #13 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #14 for AdaptiveReplacementCache.
  ...
  /**
   * Domain method #15 for AdaptiveReplacementCache.
