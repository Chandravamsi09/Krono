/**
 * @file thread_affinity.js
 * Worker thread CPU core pinning and affinity mask allocator.
...
export class ThreadAffinityManager extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'ThreadAffinityManager';
  ...
  /**
   * Domain method #1 for ThreadAffinityManager.
  ...
  /**
   * Domain method #2 for ThreadAffinityManager.
  ...
  /**
   * Domain method #3 for ThreadAffinityManager.
  ...
  /**
   * Domain method #4 for ThreadAffinityManager.
  ...
  /**
   * Domain method #5 for ThreadAffinityManager.
  ...
  /**
   * Domain method #6 for ThreadAffinityManager.
  ...
  /**
   * Domain method #7 for ThreadAffinityManager.
  ...
  /**
   * Domain method #8 for ThreadAffinityManager.
  ...
  /**
   * Domain method #9 for ThreadAffinityManager.
  ...
  /**
   * Domain method #10 for ThreadAffinityManager.
  ...
  /**
   * Domain method #11 for ThreadAffinityManager.
  ...
  /**
   * Domain method #12 for ThreadAffinityManager.
  ...
  /**
   * Domain method #13 for ThreadAffinityManager.
  ...
  /**
   * Domain method #14 for ThreadAffinityManager.
  ...
  /**
   * Domain method #15 for ThreadAffinityManager.
