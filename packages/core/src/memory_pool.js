/**
 * @file memory_pool.js
 * Direct off-heap byte buffer pool and slab allocator with power-of-two free lists.
...
export class SlabAllocator extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'SlabAllocator';
  ...
  /**
   * Domain method #1 for SlabAllocator.
  ...
  /**
   * Domain method #2 for SlabAllocator.
  ...
  /**
   * Domain method #3 for SlabAllocator.
  ...
  /**
   * Domain method #4 for SlabAllocator.
  ...
  /**
   * Domain method #5 for SlabAllocator.
  ...
  /**
   * Domain method #6 for SlabAllocator.
  ...
  /**
   * Domain method #7 for SlabAllocator.
  ...
  /**
   * Domain method #8 for SlabAllocator.
  ...
  /**
   * Domain method #9 for SlabAllocator.
  ...
  /**
   * Domain method #10 for SlabAllocator.
  ...
  /**
   * Domain method #11 for SlabAllocator.
  ...
  /**
   * Domain method #12 for SlabAllocator.
  ...
  /**
   * Domain method #13 for SlabAllocator.
  ...
  /**
   * Domain method #14 for SlabAllocator.
  ...
  /**
   * Domain method #15 for SlabAllocator.
