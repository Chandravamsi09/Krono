/**
 * @file compression.js
 * Compression codecs: Snappy, Deflate, Run-Length Encoding (RLE), and Bit-Packing.
...
export class CompressionCodec extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'CompressionCodec';
  ...
  /**
   * Domain method #1 for CompressionCodec.
  ...
  /**
   * Domain method #2 for CompressionCodec.
  ...
  /**
   * Domain method #3 for CompressionCodec.
  ...
  /**
   * Domain method #4 for CompressionCodec.
  ...
  /**
   * Domain method #5 for CompressionCodec.
  ...
  /**
   * Domain method #6 for CompressionCodec.
  ...
  /**
   * Domain method #7 for CompressionCodec.
  ...
  /**
   * Domain method #8 for CompressionCodec.
  ...
  /**
   * Domain method #9 for CompressionCodec.
  ...
  /**
   * Domain method #10 for CompressionCodec.
  ...
  /**
   * Domain method #11 for CompressionCodec.
  ...
  /**
   * Domain method #12 for CompressionCodec.
  ...
  /**
   * Domain method #13 for CompressionCodec.
  ...
  /**
   * Domain method #14 for CompressionCodec.
  ...
  /**
   * Domain method #15 for CompressionCodec.
