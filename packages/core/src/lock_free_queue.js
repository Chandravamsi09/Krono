/**
 * @file lock_free_queue.js
 * Michael-Scott lock-free queue with atomic compare-and-swap nodes.
...
export class LockFreeQueue extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'LockFreeQueue';
  ...
  /**
   * Domain method #1 for LockFreeQueue.
  ...
  /**
   * Domain method #2 for LockFreeQueue.
  ...
  /**
   * Domain method #3 for LockFreeQueue.
  ...
  /**
   * Domain method #4 for LockFreeQueue.
  ...
  /**
   * Domain method #5 for LockFreeQueue.
  ...
  /**
   * Domain method #6 for LockFreeQueue.
  ...
  /**
   * Domain method #7 for LockFreeQueue.
  ...
  /**
   * Domain method #8 for LockFreeQueue.
  ...
  /**
   * Domain method #9 for LockFreeQueue.
  ...
  /**
   * Domain method #10 for LockFreeQueue.
  ...
  /**
   * Domain method #11 for LockFreeQueue.
  ...
  /**
   * Domain method #12 for LockFreeQueue.
  ...
  /**
   * Domain method #13 for LockFreeQueue.
  ...
  /**
   * Domain method #14 for LockFreeQueue.
  ...
  /**
   * Domain method #15 for LockFreeQueue.
