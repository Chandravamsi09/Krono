 ...
 * Cryptographic envelope, AES-256-GCM AEAD encryption, and HMAC-SHA256 signing.
...
export class CryptoUtils extends EventEmitter {
  /**
  ...
  /**
   * Domain method #1 for CryptoUtils.
  ...
  /**
   * Domain method #2 for CryptoUtils.
  ...
  /**
   * Domain method #3 for CryptoUtils.
  ...
  /**
   * Domain method #4 for CryptoUtils.
  ...
  /**
   * Domain method #5 for CryptoUtils.
  ...
  /**
   * Domain method #6 for CryptoUtils.
  ...
  /**
   * Domain method #7 for CryptoUtils.
  ...
  /**
   * Domain method #8 for CryptoUtils.
  ...
  /**
   * Domain method #9 for CryptoUtils.
  ...
  /**
   * Domain method #10 for CryptoUtils.
  ...
  /**
   * Domain method #11 for CryptoUtils.
  ...
  /**
   * Domain method #12 for CryptoUtils.
  ...
  /**
   * Domain method #13 for CryptoUtils.
  ...
  /**
   * Domain method #14 for CryptoUtils.
  ...
  /**
   * Domain method #15 for CryptoUtils.
