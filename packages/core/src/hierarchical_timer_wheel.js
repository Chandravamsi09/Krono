 ...
 * 4-Level Hierarchical Timing Wheel supporting O(1) scheduling of millions of timers.
...
export class HierarchicalTimerWheel extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'HierarchicalTimerWheel';
  ...
  /**
   * Domain method #1 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #2 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #3 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #4 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #5 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #6 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #7 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #8 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #9 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #10 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #11 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #12 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #13 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #14 for HierarchicalTimerWheel.
  ...
  /**
   * Domain method #15 for HierarchicalTimerWheel.
