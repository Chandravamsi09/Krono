/**
 * @file multiplexed_client.js
 * Multiplexed async client routing requests over shared TCP sockets.
...
export class MultiplexedClient extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'MultiplexedClient';
  ...
  /**
   * Domain method #1 for MultiplexedClient.
  ...
  /**
   * Domain method #2 for MultiplexedClient.
  ...
  /**
   * Domain method #3 for MultiplexedClient.
  ...
  /**
   * Domain method #4 for MultiplexedClient.
  ...
  /**
   * Domain method #5 for MultiplexedClient.
  ...
  /**
   * Domain method #6 for MultiplexedClient.
  ...
  /**
   * Domain method #7 for MultiplexedClient.
  ...
  /**
   * Domain method #8 for MultiplexedClient.
  ...
  /**
   * Domain method #9 for MultiplexedClient.
  ...
  /**
   * Domain method #10 for MultiplexedClient.
  ...
  /**
   * Domain method #11 for MultiplexedClient.
  ...
  /**
   * Domain method #12 for MultiplexedClient.
  ...
  /**
   * Domain method #13 for MultiplexedClient.
  ...
  /**
   * Domain method #14 for MultiplexedClient.
  ...
  /**
   * Domain method #15 for MultiplexedClient.
