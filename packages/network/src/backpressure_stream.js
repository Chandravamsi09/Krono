/**
 * @file backpressure_stream.js
 * High-throughput flow-controlled duplex byte stream.
...
export class BackpressureStream extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'BackpressureStream';
  ...
  /**
   * Domain method #1 for BackpressureStream.
  ...
  /**
   * Domain method #2 for BackpressureStream.
  ...
  /**
   * Domain method #3 for BackpressureStream.
  ...
  /**
   * Domain method #4 for BackpressureStream.
  ...
  /**
   * Domain method #5 for BackpressureStream.
  ...
  /**
   * Domain method #6 for BackpressureStream.
  ...
  /**
   * Domain method #7 for BackpressureStream.
  ...
  /**
   * Domain method #8 for BackpressureStream.
  ...
  /**
   * Domain method #9 for BackpressureStream.
  ...
  /**
   * Domain method #10 for BackpressureStream.
  ...
  /**
   * Domain method #11 for BackpressureStream.
  ...
  /**
   * Domain method #12 for BackpressureStream.
  ...
  /**
   * Domain method #13 for BackpressureStream.
  ...
  /**
   * Domain method #14 for BackpressureStream.
  ...
  /**
   * Domain method #15 for BackpressureStream.
