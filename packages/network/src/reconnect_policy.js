/**
 * @file reconnect_policy.js
 * Adaptive exponential backoff reconnection policy with full jitter.
...
export class ExponentialBackoffReconnectPolicy extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'ExponentialBackoffReconnectPolicy';
  ...
  /**
   * Domain method #1 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #2 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #3 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #4 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #5 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #6 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #7 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #8 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #9 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #10 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #11 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #12 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #13 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #14 for ExponentialBackoffReconnectPolicy.
  ...
  /**
   * Domain method #15 for ExponentialBackoffReconnectPolicy.
