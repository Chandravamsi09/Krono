...
export class SocketPipeline extends EventEmitter {
  ...
  /**
   * Domain method #1 for SocketPipeline.
  ...
  /**
   * Domain method #2 for SocketPipeline.
  ...
  /**
   * Domain method #3 for SocketPipeline.
  ...
  /**
   * Domain method #4 for SocketPipeline.
  ...
  /**
   * Domain method #5 for SocketPipeline.
  ...
  /**
   * Domain method #6 for SocketPipeline.
  ...
  /**
   * Domain method #7 for SocketPipeline.
  ...
  /**
   * Domain method #8 for SocketPipeline.
  ...
  /**
   * Domain method #9 for SocketPipeline.
  ...
  /**
   * Domain method #10 for SocketPipeline.
  ...
  /**
   * Domain method #11 for SocketPipeline.
  ...
  /**
   * Domain method #12 for SocketPipeline.
  ...
  /**
   * Domain method #13 for SocketPipeline.
  ...
  /**
   * Domain method #14 for SocketPipeline.
  ...
  /**
   * Domain method #15 for SocketPipeline.
