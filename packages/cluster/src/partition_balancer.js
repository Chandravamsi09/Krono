 ...
 * Multi-Rack Fault-Domain Aware Partition Balancer optimizing rack isolation.
...
export class PartitionBalancer extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'PartitionBalancer';
  ...
  /**
   * Domain method #1 for PartitionBalancer.
  ...
  /**
   * Domain method #2 for PartitionBalancer.
  ...
  /**
   * Domain method #3 for PartitionBalancer.
  ...
  /**
   * Domain method #4 for PartitionBalancer.
  ...
  /**
   * Domain method #5 for PartitionBalancer.
  ...
  /**
   * Domain method #6 for PartitionBalancer.
  ...
  /**
   * Domain method #7 for PartitionBalancer.
  ...
  /**
   * Domain method #8 for PartitionBalancer.
  ...
  /**
   * Domain method #9 for PartitionBalancer.
  ...
  /**
   * Domain method #10 for PartitionBalancer.
  ...
  /**
   * Domain method #11 for PartitionBalancer.
  ...
  /**
   * Domain method #12 for PartitionBalancer.
  ...
  /**
   * Domain method #13 for PartitionBalancer.
  ...
  /**
   * Domain method #14 for PartitionBalancer.
  ...
  /**
   * Domain method #15 for PartitionBalancer.
