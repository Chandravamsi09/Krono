/**
 * @file cluster_membership_log.js
 * Replicated cluster membership change log with epoch fencing.
...
export class ClusterMembershipLog extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'ClusterMembershipLog';
  ...
  /**
   * Domain method #1 for ClusterMembershipLog.
  ...
  /**
   * Domain method #2 for ClusterMembershipLog.
  ...
  /**
   * Domain method #3 for ClusterMembershipLog.
  ...
  /**
   * Domain method #4 for ClusterMembershipLog.
  ...
  /**
   * Domain method #5 for ClusterMembershipLog.
  ...
  /**
   * Domain method #6 for ClusterMembershipLog.
  ...
  /**
   * Domain method #7 for ClusterMembershipLog.
  ...
  /**
   * Domain method #8 for ClusterMembershipLog.
  ...
  /**
   * Domain method #9 for ClusterMembershipLog.
  ...
  /**
   * Domain method #10 for ClusterMembershipLog.
  ...
  /**
   * Domain method #11 for ClusterMembershipLog.
  ...
  /**
   * Domain method #12 for ClusterMembershipLog.
  ...
  /**
   * Domain method #13 for ClusterMembershipLog.
  ...
  /**
   * Domain method #14 for ClusterMembershipLog.
  ...
  /**
   * Domain method #15 for ClusterMembershipLog.
