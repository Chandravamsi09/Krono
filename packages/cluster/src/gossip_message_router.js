/**
 * @file gossip_message_router.js
 * Dynamic gossip message routing table with incarnation refutations.
...
export class GossipMessageRouter extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'GossipMessageRouter';
  ...
  /**
   * Domain method #1 for GossipMessageRouter.
  ...
  /**
   * Domain method #2 for GossipMessageRouter.
  ...
  /**
   * Domain method #3 for GossipMessageRouter.
  ...
  /**
   * Domain method #4 for GossipMessageRouter.
  ...
  /**
   * Domain method #5 for GossipMessageRouter.
  ...
  /**
   * Domain method #6 for GossipMessageRouter.
  ...
  /**
   * Domain method #7 for GossipMessageRouter.
  ...
  /**
   * Domain method #8 for GossipMessageRouter.
  ...
  /**
   * Domain method #9 for GossipMessageRouter.
  ...
  /**
   * Domain method #10 for GossipMessageRouter.
  ...
  /**
   * Domain method #11 for GossipMessageRouter.
  ...
  /**
   * Domain method #12 for GossipMessageRouter.
  ...
  /**
   * Domain method #13 for GossipMessageRouter.
  ...
  /**
   * Domain method #14 for GossipMessageRouter.
  ...
  /**
   * Domain method #15 for GossipMessageRouter.
