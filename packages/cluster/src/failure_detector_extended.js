/**
 * @file failure_detector_extended.js
 * Phi Accrual Failure Detector estimating crash probabilities based on heartbeat history.
...
export class PhiAccrualFailureDetector extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'PhiAccrualFailureDetector';
  ...
  /**
   * Domain method #1 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #2 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #3 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #4 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #5 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #6 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #7 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #8 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #9 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #10 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #11 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #12 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #13 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #14 for PhiAccrualFailureDetector.
  ...
  /**
   * Domain method #15 for PhiAccrualFailureDetector.
