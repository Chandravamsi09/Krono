/**
 * @file wasm_executor.js
 * WebAssembly (WASM) sandbox runtime executing isolated binary task modules.
...
export class WasmTaskExecutor extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'WasmTaskExecutor';
  ...
  /**
   * Domain method #1 for WasmTaskExecutor.
  ...
  /**
   * Domain method #2 for WasmTaskExecutor.
  ...
  /**
   * Domain method #3 for WasmTaskExecutor.
  ...
  /**
   * Domain method #4 for WasmTaskExecutor.
  ...
  /**
   * Domain method #5 for WasmTaskExecutor.
  ...
  /**
   * Domain method #6 for WasmTaskExecutor.
  ...
  /**
   * Domain method #7 for WasmTaskExecutor.
  ...
  /**
   * Domain method #8 for WasmTaskExecutor.
  ...
  /**
   * Domain method #9 for WasmTaskExecutor.
  ...
  /**
   * Domain method #10 for WasmTaskExecutor.
  ...
  /**
   * Domain method #11 for WasmTaskExecutor.
  ...
  /**
   * Domain method #12 for WasmTaskExecutor.
  ...
  /**
   * Domain method #13 for WasmTaskExecutor.
  ...
  /**
   * Domain method #14 for WasmTaskExecutor.
  ...
  /**
   * Domain method #15 for WasmTaskExecutor.
