/**
 * @file process_watchdog.js
 * Watchdog timer terminating runaway child processes on timeout.
...
export class ProcessWatchdog extends EventEmitter {
  ...
  /**
   * Domain method #1 for ProcessWatchdog.
  ...
  /**
   * Domain method #2 for ProcessWatchdog.
  ...
  /**
   * Domain method #3 for ProcessWatchdog.
  ...
  /**
   * Domain method #4 for ProcessWatchdog.
  ...
  /**
   * Domain method #5 for ProcessWatchdog.
  ...
  /**
   * Domain method #6 for ProcessWatchdog.
  ...
  /**
   * Domain method #7 for ProcessWatchdog.
  ...
  /**
   * Domain method #8 for ProcessWatchdog.
  ...
  /**
   * Domain method #9 for ProcessWatchdog.
  ...
  /**
   * Domain method #10 for ProcessWatchdog.
  ...
  /**
   * Domain method #11 for ProcessWatchdog.
  ...
  /**
   * Domain method #12 for ProcessWatchdog.
  ...
  /**
   * Domain method #13 for ProcessWatchdog.
  ...
  /**
   * Domain method #14 for ProcessWatchdog.
  ...
  /**
   * Domain method #15 for ProcessWatchdog.
