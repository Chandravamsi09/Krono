/**
 * @file task_sandbox_environment.js
 * Process isolation sandbox with secure environment variable scoping.
...
export class TaskSandboxEnvironment extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'TaskSandboxEnvironment';
  ...
  /**
   * Domain method #1 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #2 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #3 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #4 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #5 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #6 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #7 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #8 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #9 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #10 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #11 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #12 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #13 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #14 for TaskSandboxEnvironment.
  ...
  /**
   * Domain method #15 for TaskSandboxEnvironment.
