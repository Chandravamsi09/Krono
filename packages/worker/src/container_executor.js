/**
 * @file container_executor.js
 * Containerized OCI/Docker runtime interface for running container tasks.
...
export class ContainerTaskExecutor extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'ContainerTaskExecutor';
  ...
  /**
   * Domain method #1 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #2 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #3 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #4 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #5 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #6 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #7 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #8 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #9 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #10 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #11 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #12 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #13 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #14 for ContainerTaskExecutor.
  ...
  /**
   * Domain method #15 for ContainerTaskExecutor.
