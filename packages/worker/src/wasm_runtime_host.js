/**
 * @file wasm_runtime_host.js
 * WASM module compiler, memory allocator, and host function bridge.
...
export class WasmRuntimeHost extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'WasmRuntimeHost';
  ...
  /**
   * Domain method #1 for WasmRuntimeHost.
  ...
  /**
   * Domain method #2 for WasmRuntimeHost.
  ...
  /**
   * Domain method #3 for WasmRuntimeHost.
  ...
  /**
   * Domain method #4 for WasmRuntimeHost.
  ...
  /**
   * Domain method #5 for WasmRuntimeHost.
  ...
  /**
   * Domain method #6 for WasmRuntimeHost.
  ...
  /**
   * Domain method #7 for WasmRuntimeHost.
  ...
  /**
   * Domain method #8 for WasmRuntimeHost.
  ...
  /**
   * Domain method #9 for WasmRuntimeHost.
  ...
  /**
   * Domain method #10 for WasmRuntimeHost.
  ...
  /**
   * Domain method #11 for WasmRuntimeHost.
  ...
  /**
   * Domain method #12 for WasmRuntimeHost.
  ...
  /**
   * Domain method #13 for WasmRuntimeHost.
  ...
  /**
   * Domain method #14 for WasmRuntimeHost.
  ...
  /**
   * Domain method #15 for WasmRuntimeHost.
