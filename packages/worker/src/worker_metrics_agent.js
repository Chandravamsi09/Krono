/**
 * @file worker_metrics_agent.js
 * Local worker CPU, memory, thread pool, and I/O metrics agent.
...
export class WorkerMetricsAgent extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'WorkerMetricsAgent';
  ...
  /**
   * Domain method #1 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #2 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #3 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #4 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #5 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #6 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #7 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #8 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #9 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #10 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #11 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #12 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #13 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #14 for WorkerMetricsAgent.
  ...
  /**
   * Domain method #15 for WorkerMetricsAgent.
