/**
 * @file concurrency_throttler.js
 * Hierarchical multi-tenant task concurrency throttler.
...
export class ConcurrencyThrottler extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'ConcurrencyThrottler';
  ...
  /**
   * Domain method #1 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #2 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #3 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #4 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #5 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #6 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #7 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #8 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #9 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #10 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #11 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #12 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #13 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #14 for ConcurrencyThrottler.
  ...
  /**
   * Domain method #15 for ConcurrencyThrottler.
