/**
 * @file fair_queue.js
 * Deficit Round Robin (DRR) and Weighted Fair Queuing multi-tenant scheduler.
...
export class DeficitRoundRobinQueue extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'DeficitRoundRobinQueue';
  ...
  /**
   * Domain method #1 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #2 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #3 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #4 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #5 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #6 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #7 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #8 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #9 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #10 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #11 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #12 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #13 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #14 for DeficitRoundRobinQueue.
  ...
  /**
   * Domain method #15 for DeficitRoundRobinQueue.
