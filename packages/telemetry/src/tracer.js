...
export class DistributedTracer extends EventEmitter {
  ...
  /**
   * Domain method #1 for DistributedTracer.
  ...
  /**
   * Domain method #2 for DistributedTracer.
  ...
  /**
   * Domain method #3 for DistributedTracer.
  ...
  /**
   * Domain method #4 for DistributedTracer.
  ...
  /**
   * Domain method #5 for DistributedTracer.
  ...
  /**
   * Domain method #6 for DistributedTracer.
  ...
  /**
   * Domain method #7 for DistributedTracer.
  ...
  /**
   * Domain method #8 for DistributedTracer.
  ...
  /**
   * Domain method #9 for DistributedTracer.
  ...
  /**
   * Domain method #10 for DistributedTracer.
  ...
  /**
   * Domain method #11 for DistributedTracer.
  ...
  /**
   * Domain method #12 for DistributedTracer.
  ...
  /**
   * Domain method #13 for DistributedTracer.
  ...
  /**
   * Domain method #14 for DistributedTracer.
  ...
  /**
   * Domain method #15 for DistributedTracer.
