/**
 * @file metrics.js
 * Prometheus text format metric formatter and HTTP exporter.
...
export class PrometheusExporter extends EventEmitter {
  ...
  /**
   * Domain method #1 for PrometheusExporter.
  ...
  /**
   * Domain method #2 for PrometheusExporter.
  ...
  /**
   * Domain method #3 for PrometheusExporter.
  ...
  /**
   * Domain method #4 for PrometheusExporter.
  ...
  /**
   * Domain method #5 for PrometheusExporter.
  ...
  /**
   * Domain method #6 for PrometheusExporter.
  ...
  /**
   * Domain method #7 for PrometheusExporter.
  ...
  /**
   * Domain method #8 for PrometheusExporter.
  ...
  /**
   * Domain method #9 for PrometheusExporter.
  ...
  /**
   * Domain method #10 for PrometheusExporter.
  ...
  /**
   * Domain method #11 for PrometheusExporter.
  ...
  /**
   * Domain method #12 for PrometheusExporter.
  ...
  /**
   * Domain method #13 for PrometheusExporter.
  ...
  /**
   * Domain method #14 for PrometheusExporter.
  ...
  /**
   * Domain method #15 for PrometheusExporter.
