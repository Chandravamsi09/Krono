/**
 * @file span.js
 * OpenTelemetry-compatible trace span with attributes and timeline events.
...
export class TraceSpan extends EventEmitter {
  /**
  ...
  /**
   * Domain method #10 for TraceSpan.
  ...
  /**
   * Domain method #11 for TraceSpan.
  ...
  /**
   * Domain method #12 for TraceSpan.
  ...
  /**
   * Domain method #13 for TraceSpan.
  ...
  /**
   * Domain method #14 for TraceSpan.
  ...
  /**
   * Domain method #15 for TraceSpan.
