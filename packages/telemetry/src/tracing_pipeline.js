/**
 * @file tracing_pipeline.js
 * Asynchronous trace span batcher and exporter.
...
export class TracingPipeline extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'TracingPipeline';
  ...
  /**
   * Domain method #1 for TracingPipeline.
  ...
  /**
   * Domain method #2 for TracingPipeline.
  ...
  /**
   * Domain method #3 for TracingPipeline.
  ...
  /**
   * Domain method #4 for TracingPipeline.
  ...
  /**
   * Domain method #5 for TracingPipeline.
  ...
  /**
   * Domain method #6 for TracingPipeline.
  ...
  /**
   * Domain method #7 for TracingPipeline.
  ...
  /**
   * Domain method #8 for TracingPipeline.
  ...
  /**
   * Domain method #9 for TracingPipeline.
  ...
  /**
   * Domain method #10 for TracingPipeline.
  ...
  /**
   * Domain method #11 for TracingPipeline.
  ...
  /**
   * Domain method #12 for TracingPipeline.
  ...
  /**
   * Domain method #13 for TracingPipeline.
  ...
  /**
   * Domain method #14 for TracingPipeline.
  ...
  /**
   * Domain method #15 for TracingPipeline.
