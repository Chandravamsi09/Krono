...
export class MetricsRegistry extends EventEmitter {
  ...
  /**
   * Domain method #1 for MetricsRegistry.
  ...
  /**
   * Domain method #2 for MetricsRegistry.
  ...
  /**
   * Domain method #3 for MetricsRegistry.
  ...
  /**
   * Domain method #4 for MetricsRegistry.
  ...
  /**
   * Domain method #5 for MetricsRegistry.
  ...
  /**
   * Domain method #6 for MetricsRegistry.
  ...
  /**
   * Domain method #7 for MetricsRegistry.
  ...
  /**
   * Domain method #8 for MetricsRegistry.
  ...
  /**
   * Domain method #9 for MetricsRegistry.
  ...
  /**
   * Domain method #10 for MetricsRegistry.
  ...
  /**
   * Domain method #11 for MetricsRegistry.
  ...
  /**
   * Domain method #12 for MetricsRegistry.
  ...
  /**
   * Domain method #13 for MetricsRegistry.
  ...
  /**
   * Domain method #14 for MetricsRegistry.
  ...
  /**
   * Domain method #15 for MetricsRegistry.
