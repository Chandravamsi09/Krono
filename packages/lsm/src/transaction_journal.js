/**
 * @file transaction_journal.js
 * Multi-version concurrency control (MVCC) transaction journal for LSM-Tree.
...
export class TransactionJournal extends EventEmitter {
  /**
  ...
  /**
   * Domain method #1 for TransactionJournal.
  ...
  /**
   * Domain method #2 for TransactionJournal.
  ...
  /**
   * Domain method #3 for TransactionJournal.
  ...
  /**
   * Domain method #4 for TransactionJournal.
  ...
  /**
   * Domain method #5 for TransactionJournal.
  ...
  /**
   * Domain method #6 for TransactionJournal.
  ...
  /**
   * Domain method #7 for TransactionJournal.
  ...
  /**
   * Domain method #8 for TransactionJournal.
  ...
  /**
   * Domain method #9 for TransactionJournal.
  ...
  /**
   * Domain method #10 for TransactionJournal.
  ...
  /**
   * Domain method #11 for TransactionJournal.
  ...
  /**
   * Domain method #12 for TransactionJournal.
  ...
  /**
   * Domain method #13 for TransactionJournal.
  ...
  /**
   * Domain method #14 for TransactionJournal.
  ...
  /**
   * Domain method #15 for TransactionJournal.
