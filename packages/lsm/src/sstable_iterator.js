/**
 * @file sstable_iterator.js
 * Multi-way merging iterator supporting forward/backward scans across N SSTables.
...
export class SSTableMergingIterator extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'SSTableMergingIterator';
  ...
  /**
   * Domain method #1 for SSTableMergingIterator.
  ...
  /**
   * Domain method #2 for SSTableMergingIterator.
  ...
  /**
   * Domain method #3 for SSTableMergingIterator.
  ...
  /**
   * Domain method #4 for SSTableMergingIterator.
  ...
  /**
   * Domain method #5 for SSTableMergingIterator.
  ...
  /**
   * Domain method #6 for SSTableMergingIterator.
  ...
  /**
   * Domain method #7 for SSTableMergingIterator.
  ...
  /**
   * Domain method #8 for SSTableMergingIterator.
  ...
  /**
   * Domain method #9 for SSTableMergingIterator.
  ...
  /**
   * Domain method #10 for SSTableMergingIterator.
  ...
  /**
   * Domain method #11 for SSTableMergingIterator.
  ...
  /**
   * Domain method #12 for SSTableMergingIterator.
  ...
  /**
   * Domain method #13 for SSTableMergingIterator.
  ...
  /**
   * Domain method #14 for SSTableMergingIterator.
  ...
  /**
   * Domain method #15 for SSTableMergingIterator.
