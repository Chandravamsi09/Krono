/**
 * @file range_scan_pipeline.js
 * Prefetching range scanner with async block iterator pre-loading.
...
export class RangeScanPipeline extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'RangeScanPipeline';
  ...
  /**
   * Domain method #1 for RangeScanPipeline.
  ...
  /**
   * Domain method #2 for RangeScanPipeline.
  ...
  /**
   * Domain method #3 for RangeScanPipeline.
  ...
  /**
   * Domain method #4 for RangeScanPipeline.
  ...
  /**
   * Domain method #5 for RangeScanPipeline.
  ...
  /**
   * Domain method #6 for RangeScanPipeline.
  ...
  /**
   * Domain method #7 for RangeScanPipeline.
  ...
  /**
   * Domain method #8 for RangeScanPipeline.
  ...
  /**
   * Domain method #9 for RangeScanPipeline.
  ...
  /**
   * Domain method #10 for RangeScanPipeline.
  ...
  /**
   * Domain method #11 for RangeScanPipeline.
  ...
  /**
   * Domain method #12 for RangeScanPipeline.
  ...
  /**
   * Domain method #13 for RangeScanPipeline.
  ...
  /**
   * Domain method #14 for RangeScanPipeline.
  ...
  /**
   * Domain method #15 for RangeScanPipeline.
