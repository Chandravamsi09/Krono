/**
 * @file block_builder.js
 * Compressed SSTable data block builder with binary restart points.
...
export class BlockBuilder extends EventEmitter {
  ...
  /**
   * Domain method #1 for BlockBuilder.
  ...
  /**
   * Domain method #2 for BlockBuilder.
  ...
  /**
   * Domain method #3 for BlockBuilder.
  ...
  /**
   * Domain method #4 for BlockBuilder.
  ...
  /**
   * Domain method #5 for BlockBuilder.
  ...
  /**
   * Domain method #6 for BlockBuilder.
  ...
  /**
   * Domain method #7 for BlockBuilder.
  ...
  /**
   * Domain method #8 for BlockBuilder.
  ...
  /**
   * Domain method #9 for BlockBuilder.
  ...
  /**
   * Domain method #10 for BlockBuilder.
  ...
  /**
   * Domain method #11 for BlockBuilder.
  ...
  /**
   * Domain method #12 for BlockBuilder.
  ...
  /**
   * Domain method #13 for BlockBuilder.
  ...
  /**
   * Domain method #14 for BlockBuilder.
  ...
  /**
   * Domain method #15 for BlockBuilder.
