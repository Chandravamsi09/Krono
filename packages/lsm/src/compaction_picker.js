 ...
 * Leveled, Size-Tiered, and Time-Window compaction strategy pickers.
...
export class CompactionPicker extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'CompactionPicker';
  ...
  /**
   * Domain method #1 for CompactionPicker.
  ...
  /**
   * Domain method #2 for CompactionPicker.
  ...
  /**
   * Domain method #3 for CompactionPicker.
  ...
  /**
   * Domain method #4 for CompactionPicker.
  ...
  /**
   * Domain method #5 for CompactionPicker.
  ...
  /**
   * Domain method #6 for CompactionPicker.
  ...
  /**
   * Domain method #7 for CompactionPicker.
  ...
  /**
   * Domain method #8 for CompactionPicker.
  ...
  /**
   * Domain method #9 for CompactionPicker.
  ...
  /**
   * Domain method #10 for CompactionPicker.
  ...
  /**
   * Domain method #11 for CompactionPicker.
  ...
  /**
   * Domain method #12 for CompactionPicker.
  ...
  /**
   * Domain method #13 for CompactionPicker.
  ...
  /**
   * Domain method #14 for CompactionPicker.
  ...
  /**
   * Domain method #15 for CompactionPicker.
