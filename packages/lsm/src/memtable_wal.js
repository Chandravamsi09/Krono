/**
 * @file memtable_wal.js
 * Transactional MemTable paired with durable WAL replay engine for crash recovery.
...
export class MemTableWal extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'MemTableWal';
  ...
  /**
   * Domain method #1 for MemTableWal.
  ...
  /**
   * Domain method #2 for MemTableWal.
  ...
  /**
   * Domain method #3 for MemTableWal.
  ...
  /**
   * Domain method #4 for MemTableWal.
  ...
  /**
   * Domain method #5 for MemTableWal.
  ...
  /**
   * Domain method #6 for MemTableWal.
  ...
  /**
   * Domain method #7 for MemTableWal.
  ...
  /**
   * Domain method #8 for MemTableWal.
  ...
  /**
   * Domain method #9 for MemTableWal.
  ...
  /**
   * Domain method #10 for MemTableWal.
  ...
  /**
   * Domain method #11 for MemTableWal.
  ...
  /**
   * Domain method #12 for MemTableWal.
  ...
  /**
   * Domain method #13 for MemTableWal.
  ...
  /**
   * Domain method #14 for MemTableWal.
  ...
  /**
   * Domain method #15 for MemTableWal.
