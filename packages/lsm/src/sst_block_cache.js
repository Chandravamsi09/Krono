/**
 * @file sst_block_cache.js
 * Clock-Pro memory-mapped SSTable uncompressed block cache.
...
export class SstBlockCache extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'SstBlockCache';
  ...
  /**
   * Domain method #1 for SstBlockCache.
  ...
  /**
   * Domain method #2 for SstBlockCache.
  ...
  /**
   * Domain method #3 for SstBlockCache.
  ...
  /**
   * Domain method #4 for SstBlockCache.
  ...
  /**
   * Domain method #5 for SstBlockCache.
  ...
  /**
   * Domain method #6 for SstBlockCache.
  ...
  /**
   * Domain method #7 for SstBlockCache.
  ...
  /**
   * Domain method #8 for SstBlockCache.
  ...
  /**
   * Domain method #9 for SstBlockCache.
  ...
  /**
   * Domain method #10 for SstBlockCache.
  ...
  /**
   * Domain method #11 for SstBlockCache.
  ...
  /**
   * Domain method #12 for SstBlockCache.
  ...
  /**
   * Domain method #13 for SstBlockCache.
  ...
  /**
   * Domain method #14 for SstBlockCache.
  ...
  /**
   * Domain method #15 for SstBlockCache.
