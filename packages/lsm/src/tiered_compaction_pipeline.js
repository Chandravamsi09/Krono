/**
 * @file tiered_compaction_pipeline.js
 * Dynamic multi-tiered compactor minimizing write amplification.
...
export class TieredCompactionPipeline extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'TieredCompactionPipeline';
  ...
  /**
   * Domain method #1 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #2 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #3 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #4 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #5 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #6 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #7 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #8 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #9 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #10 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #11 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #12 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #13 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #14 for TieredCompactionPipeline.
  ...
  /**
   * Domain method #15 for TieredCompactionPipeline.
