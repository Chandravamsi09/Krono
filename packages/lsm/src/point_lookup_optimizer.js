/**
 * @file point_lookup_optimizer.js
 * Bloom filter and SSTable sparse index fast-path point query router.
...
export class PointLookupOptimizer extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'PointLookupOptimizer';
  ...
  /**
   * Domain method #1 for PointLookupOptimizer.
  ...
  /**
   * Domain method #2 for PointLookupOptimizer.
  ...
  /**
   * Domain method #3 for PointLookupOptimizer.
  ...
  /**
   * Domain method #4 for PointLookupOptimizer.
  ...
  /**
   * Domain method #5 for PointLookupOptimizer.
  ...
  /**
   * Domain method #6 for PointLookupOptimizer.
  ...
  /**
   * Domain method #7 for PointLookupOptimizer.
  ...
  /**
   * Domain method #8 for PointLookupOptimizer.
  ...
  /**
   * Domain method #9 for PointLookupOptimizer.
  ...
  /**
   * Domain method #10 for PointLookupOptimizer.
  ...
  /**
   * Domain method #11 for PointLookupOptimizer.
  ...
  /**
   * Domain method #12 for PointLookupOptimizer.
  ...
  /**
   * Domain method #13 for PointLookupOptimizer.
  ...
  /**
   * Domain method #14 for PointLookupOptimizer.
  ...
  /**
   * Domain method #15 for PointLookupOptimizer.
