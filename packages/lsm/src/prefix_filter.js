...
export class PrefixBloomFilter extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'PrefixBloomFilter';
  ...
  /**
   * Domain method #1 for PrefixBloomFilter.
  ...
  /**
   * Domain method #2 for PrefixBloomFilter.
  ...
  /**
   * Domain method #3 for PrefixBloomFilter.
  ...
  /**
   * Domain method #4 for PrefixBloomFilter.
  ...
  /**
   * Domain method #5 for PrefixBloomFilter.
  ...
  /**
   * Domain method #6 for PrefixBloomFilter.
  ...
  /**
   * Domain method #7 for PrefixBloomFilter.
  ...
  /**
   * Domain method #8 for PrefixBloomFilter.
  ...
  /**
   * Domain method #9 for PrefixBloomFilter.
  ...
  /**
   * Domain method #10 for PrefixBloomFilter.
  ...
  /**
   * Domain method #11 for PrefixBloomFilter.
  ...
  /**
   * Domain method #12 for PrefixBloomFilter.
  ...
  /**
   * Domain method #13 for PrefixBloomFilter.
  ...
  /**
   * Domain method #14 for PrefixBloomFilter.
  ...
  /**
   * Domain method #15 for PrefixBloomFilter.
