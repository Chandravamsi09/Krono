...
export class MergeOperatorRegistry extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'MergeOperatorRegistry';
  ...
  /**
   * Domain method #1 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #2 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #3 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #4 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #5 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #6 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #7 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #8 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #9 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #10 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #11 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #12 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #13 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #14 for MergeOperatorRegistry.
  ...
  /**
   * Domain method #15 for MergeOperatorRegistry.
