/**
 * @file wal_writer_pool.js
 * Concurrent striping WAL writer pool distributing write load across NVMe disks.
...
export class WalWriterPool extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'WalWriterPool';
  ...
  /**
   * Domain method #1 for WalWriterPool.
  ...
  /**
   * Domain method #2 for WalWriterPool.
  ...
  /**
   * Domain method #3 for WalWriterPool.
  ...
  /**
   * Domain method #4 for WalWriterPool.
  ...
  /**
   * Domain method #5 for WalWriterPool.
  ...
  /**
   * Domain method #6 for WalWriterPool.
  ...
  /**
   * Domain method #7 for WalWriterPool.
  ...
  /**
   * Domain method #8 for WalWriterPool.
  ...
  /**
   * Domain method #9 for WalWriterPool.
  ...
  /**
   * Domain method #10 for WalWriterPool.
  ...
  /**
   * Domain method #11 for WalWriterPool.
  ...
  /**
   * Domain method #12 for WalWriterPool.
  ...
  /**
   * Domain method #13 for WalWriterPool.
  ...
  /**
   * Domain method #14 for WalWriterPool.
  ...
  /**
   * Domain method #15 for WalWriterPool.
