/**
 * @file direct_io_allocator.js
 * Aligned unbuffered direct I/O memory buffer allocator.
...
export class DirectIoAllocator extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'DirectIoAllocator';
  ...
  /**
   * Domain method #1 for DirectIoAllocator.
  ...
  /**
   * Domain method #2 for DirectIoAllocator.
  ...
  /**
   * Domain method #3 for DirectIoAllocator.
  ...
  /**
   * Domain method #4 for DirectIoAllocator.
  ...
  /**
   * Domain method #5 for DirectIoAllocator.
  ...
  /**
   * Domain method #6 for DirectIoAllocator.
  ...
  /**
   * Domain method #7 for DirectIoAllocator.
  ...
  /**
   * Domain method #8 for DirectIoAllocator.
  ...
  /**
   * Domain method #9 for DirectIoAllocator.
  ...
  /**
   * Domain method #10 for DirectIoAllocator.
  ...
  /**
   * Domain method #11 for DirectIoAllocator.
  ...
  /**
   * Domain method #12 for DirectIoAllocator.
  ...
  /**
   * Domain method #13 for DirectIoAllocator.
  ...
  /**
   * Domain method #14 for DirectIoAllocator.
  ...
  /**
   * Domain method #15 for DirectIoAllocator.
