/**
 * @file storage_metrics_collector.js
 * Low-overhead IOPS, write amplification, and disk latency metric sampler.
...
export class StorageMetricsCollector extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'StorageMetricsCollector';
  ...
  /**
   * Domain method #1 for StorageMetricsCollector.
  ...
  /**
   * Domain method #2 for StorageMetricsCollector.
  ...
  /**
   * Domain method #3 for StorageMetricsCollector.
  ...
  /**
   * Domain method #4 for StorageMetricsCollector.
  ...
  /**
   * Domain method #5 for StorageMetricsCollector.
  ...
  /**
   * Domain method #6 for StorageMetricsCollector.
  ...
  /**
   * Domain method #7 for StorageMetricsCollector.
  ...
  /**
   * Domain method #8 for StorageMetricsCollector.
  ...
  /**
   * Domain method #9 for StorageMetricsCollector.
  ...
  /**
   * Domain method #10 for StorageMetricsCollector.
  ...
  /**
   * Domain method #11 for StorageMetricsCollector.
  ...
  /**
   * Domain method #12 for StorageMetricsCollector.
  ...
  /**
   * Domain method #13 for StorageMetricsCollector.
  ...
  /**
   * Domain method #14 for StorageMetricsCollector.
  ...
  /**
   * Domain method #15 for StorageMetricsCollector.
