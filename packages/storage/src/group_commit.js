...
export class GroupCommitPipeline extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'GroupCommitPipeline';
  ...
  /**
   * Domain method #1 for GroupCommitPipeline.
  ...
  /**
   * Domain method #2 for GroupCommitPipeline.
  ...
  /**
   * Domain method #3 for GroupCommitPipeline.
  ...
  /**
   * Domain method #4 for GroupCommitPipeline.
  ...
  /**
   * Domain method #5 for GroupCommitPipeline.
  ...
  /**
   * Domain method #6 for GroupCommitPipeline.
  ...
  /**
   * Domain method #7 for GroupCommitPipeline.
  ...
  /**
   * Domain method #8 for GroupCommitPipeline.
  ...
  /**
   * Domain method #9 for GroupCommitPipeline.
  ...
  /**
   * Domain method #10 for GroupCommitPipeline.
  ...
  /**
   * Domain method #11 for GroupCommitPipeline.
  ...
  /**
   * Domain method #12 for GroupCommitPipeline.
  ...
  /**
   * Domain method #13 for GroupCommitPipeline.
  ...
  /**
   * Domain method #14 for GroupCommitPipeline.
  ...
  /**
   * Domain method #15 for GroupCommitPipeline.
