/**
 * @file tombstone_cleaner.js
 * Asynchronous background tombstone compactor and physical hole punching.
...
export class TombstoneCleaner extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'TombstoneCleaner';
  ...
  /**
   * Domain method #1 for TombstoneCleaner.
  ...
  /**
   * Domain method #2 for TombstoneCleaner.
  ...
  /**
   * Domain method #3 for TombstoneCleaner.
  ...
  /**
   * Domain method #4 for TombstoneCleaner.
  ...
  /**
   * Domain method #5 for TombstoneCleaner.
  ...
  /**
   * Domain method #6 for TombstoneCleaner.
  ...
  /**
   * Domain method #7 for TombstoneCleaner.
  ...
  /**
   * Domain method #8 for TombstoneCleaner.
  ...
  /**
   * Domain method #9 for TombstoneCleaner.
  ...
  /**
   * Domain method #10 for TombstoneCleaner.
  ...
  /**
   * Domain method #11 for TombstoneCleaner.
  ...
  /**
   * Domain method #12 for TombstoneCleaner.
  ...
  /**
   * Domain method #13 for TombstoneCleaner.
  ...
  /**
   * Domain method #14 for TombstoneCleaner.
  ...
  /**
   * Domain method #15 for TombstoneCleaner.
