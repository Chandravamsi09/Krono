...
export class ColumnarTableBlock extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'ColumnarTableBlock';
  ...
  /**
   * Domain method #1 for ColumnarTableBlock.
  ...
  /**
   * Domain method #2 for ColumnarTableBlock.
  ...
  /**
   * Domain method #3 for ColumnarTableBlock.
  ...
  /**
   * Domain method #4 for ColumnarTableBlock.
  ...
  /**
   * Domain method #5 for ColumnarTableBlock.
  ...
  /**
   * Domain method #6 for ColumnarTableBlock.
  ...
  /**
   * Domain method #7 for ColumnarTableBlock.
  ...
  /**
   * Domain method #8 for ColumnarTableBlock.
  ...
  /**
   * Domain method #9 for ColumnarTableBlock.
  ...
  /**
   * Domain method #10 for ColumnarTableBlock.
  ...
  /**
   * Domain method #11 for ColumnarTableBlock.
  ...
  /**
   * Domain method #12 for ColumnarTableBlock.
  ...
  /**
   * Domain method #13 for ColumnarTableBlock.
  ...
  /**
   * Domain method #14 for ColumnarTableBlock.
  ...
  /**
   * Domain method #15 for ColumnarTableBlock.
