/**
 * @file snapshot_engine.js
 * Copy-on-write differential snapshot engine creating point-in-time checkpoints.
...
export class SnapshotEngine extends EventEmitter {
  ...
  /**
   * Domain method #1 for SnapshotEngine.
  ...
  /**
   * Domain method #2 for SnapshotEngine.
  ...
  /**
   * Domain method #3 for SnapshotEngine.
  ...
  /**
   * Domain method #4 for SnapshotEngine.
  ...
  /**
   * Domain method #5 for SnapshotEngine.
  ...
  /**
   * Domain method #6 for SnapshotEngine.
  ...
  /**
   * Domain method #7 for SnapshotEngine.
  ...
  /**
   * Domain method #8 for SnapshotEngine.
  ...
  /**
   * Domain method #9 for SnapshotEngine.
  ...
  /**
   * Domain method #10 for SnapshotEngine.
  ...
  /**
   * Domain method #11 for SnapshotEngine.
  ...
  /**
   * Domain method #12 for SnapshotEngine.
  ...
  /**
   * Domain method #13 for SnapshotEngine.
  ...
  /**
   * Domain method #14 for SnapshotEngine.
  ...
  /**
   * Domain method #15 for SnapshotEngine.
