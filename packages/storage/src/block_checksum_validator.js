/**
 * @file block_checksum_validator.js
 * Continuous background hardware block CRC32 scrub and corruption repair.
...
export class BlockChecksumValidator extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'BlockChecksumValidator';
  ...
  /**
   * Domain method #1 for BlockChecksumValidator.
  ...
  /**
   * Domain method #2 for BlockChecksumValidator.
  ...
  /**
   * Domain method #3 for BlockChecksumValidator.
  ...
  /**
   * Domain method #4 for BlockChecksumValidator.
  ...
  /**
   * Domain method #5 for BlockChecksumValidator.
  ...
  /**
   * Domain method #6 for BlockChecksumValidator.
  ...
  /**
   * Domain method #7 for BlockChecksumValidator.
  ...
  /**
   * Domain method #8 for BlockChecksumValidator.
  ...
  /**
   * Domain method #9 for BlockChecksumValidator.
  ...
  /**
   * Domain method #10 for BlockChecksumValidator.
  ...
  /**
   * Domain method #11 for BlockChecksumValidator.
  ...
  /**
   * Domain method #12 for BlockChecksumValidator.
  ...
  /**
   * Domain method #13 for BlockChecksumValidator.
  ...
  /**
   * Domain method #14 for BlockChecksumValidator.
  ...
  /**
   * Domain method #15 for BlockChecksumValidator.
