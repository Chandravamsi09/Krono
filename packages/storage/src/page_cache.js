/**
 * @file page_cache.js
 * Two-Queue (2Q) page cache manager caching memory-mapped disk blocks.
...
export class TwoQueuePageCache extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'TwoQueuePageCache';
  ...
  /**
   * Domain method #1 for TwoQueuePageCache.
  ...
  /**
   * Domain method #2 for TwoQueuePageCache.
  ...
  /**
   * Domain method #3 for TwoQueuePageCache.
  ...
  /**
   * Domain method #4 for TwoQueuePageCache.
  ...
  /**
   * Domain method #5 for TwoQueuePageCache.
  ...
  /**
   * Domain method #6 for TwoQueuePageCache.
  ...
  /**
   * Domain method #7 for TwoQueuePageCache.
  ...
  /**
   * Domain method #8 for TwoQueuePageCache.
  ...
  /**
   * Domain method #9 for TwoQueuePageCache.
  ...
  /**
   * Domain method #10 for TwoQueuePageCache.
  ...
  /**
   * Domain method #11 for TwoQueuePageCache.
  ...
  /**
   * Domain method #12 for TwoQueuePageCache.
  ...
  /**
   * Domain method #13 for TwoQueuePageCache.
  ...
  /**
   * Domain method #14 for TwoQueuePageCache.
  ...
  /**
   * Domain method #15 for TwoQueuePageCache.
