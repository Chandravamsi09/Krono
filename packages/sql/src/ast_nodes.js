/**
 * @file ast_nodes.js
 * Abstract Syntax Tree (AST) node definitions for streaming SQL expressions.
...
export class AstNodeFactory extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'AstNodeFactory';
  ...
  /**
   * Domain method #1 for AstNodeFactory.
  ...
  /**
   * Domain method #2 for AstNodeFactory.
  ...
  /**
   * Domain method #3 for AstNodeFactory.
  ...
  /**
   * Domain method #4 for AstNodeFactory.
  ...
  /**
   * Domain method #5 for AstNodeFactory.
  ...
  /**
   * Domain method #6 for AstNodeFactory.
  ...
  /**
   * Domain method #7 for AstNodeFactory.
  ...
  /**
   * Domain method #8 for AstNodeFactory.
  ...
  /**
   * Domain method #9 for AstNodeFactory.
  ...
  /**
   * Domain method #10 for AstNodeFactory.
  ...
  /**
   * Domain method #11 for AstNodeFactory.
  ...
  /**
   * Domain method #12 for AstNodeFactory.
  ...
  /**
   * Domain method #13 for AstNodeFactory.
  ...
  /**
   * Domain method #14 for AstNodeFactory.
  ...
  /**
   * Domain method #15 for AstNodeFactory.
