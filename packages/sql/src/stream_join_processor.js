/**
 * @file stream_join_processor.js
 * Temporal interval stream-to-stream join processor.
...
export class StreamJoinProcessor extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'StreamJoinProcessor';
  ...
  /**
   * Domain method #1 for StreamJoinProcessor.
  ...
  /**
   * Domain method #2 for StreamJoinProcessor.
  ...
  /**
   * Domain method #3 for StreamJoinProcessor.
  ...
  /**
   * Domain method #4 for StreamJoinProcessor.
  ...
  /**
   * Domain method #5 for StreamJoinProcessor.
  ...
  /**
   * Domain method #6 for StreamJoinProcessor.
  ...
  /**
   * Domain method #7 for StreamJoinProcessor.
  ...
  /**
   * Domain method #8 for StreamJoinProcessor.
  ...
  /**
   * Domain method #9 for StreamJoinProcessor.
  ...
  /**
   * Domain method #10 for StreamJoinProcessor.
  ...
  /**
   * Domain method #11 for StreamJoinProcessor.
  ...
  /**
   * Domain method #12 for StreamJoinProcessor.
  ...
  /**
   * Domain method #13 for StreamJoinProcessor.
  ...
  /**
   * Domain method #14 for StreamJoinProcessor.
  ...
  /**
   * Domain method #15 for StreamJoinProcessor.
