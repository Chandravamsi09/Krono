/**
 * @file window_aggregator.js
 * Tumbling, Hopping, and Sliding window aggregators (COUNT, SUM, AVG, MIN, MAX).
...
export class WindowAggregator extends EventEmitter {
  ...
  /**
   * Domain method #1 for WindowAggregator.
  ...
  /**
   * Domain method #2 for WindowAggregator.
  ...
  /**
   * Domain method #3 for WindowAggregator.
  ...
  /**
   * Domain method #4 for WindowAggregator.
  ...
  /**
   * Domain method #5 for WindowAggregator.
  ...
  /**
   * Domain method #6 for WindowAggregator.
  ...
  /**
   * Domain method #7 for WindowAggregator.
  ...
  /**
   * Domain method #8 for WindowAggregator.
  ...
  /**
   * Domain method #9 for WindowAggregator.
  ...
  /**
   * Domain method #10 for WindowAggregator.
  ...
  /**
   * Domain method #11 for WindowAggregator.
  ...
  /**
   * Domain method #12 for WindowAggregator.
  ...
  /**
   * Domain method #13 for WindowAggregator.
  ...
  /**
   * Domain method #14 for WindowAggregator.
  ...
  /**
   * Domain method #15 for WindowAggregator.
