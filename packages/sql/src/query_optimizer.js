/**
 * @file query_optimizer.js
 * Rule-based streaming query optimizer performing filter pushdowns and projection pruning.
...
export class StreamingQueryOptimizer extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'StreamingQueryOptimizer';
  ...
  /**
   * Domain method #1 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #2 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #3 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #4 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #5 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #6 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #7 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #8 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #9 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #10 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #11 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #12 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #13 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #14 for StreamingQueryOptimizer.
  ...
  /**
   * Domain method #15 for StreamingQueryOptimizer.
