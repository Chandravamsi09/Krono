...
export class SqlTokenizer extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'SqlTokenizer';
  ...
  /**
   * Domain method #1 for SqlTokenizer.
  ...
  /**
   * Domain method #2 for SqlTokenizer.
  ...
  /**
   * Domain method #3 for SqlTokenizer.
  ...
  /**
   * Domain method #4 for SqlTokenizer.
  ...
  /**
   * Domain method #5 for SqlTokenizer.
  ...
  /**
   * Domain method #6 for SqlTokenizer.
  ...
  /**
   * Domain method #7 for SqlTokenizer.
  ...
  /**
   * Domain method #8 for SqlTokenizer.
  ...
  /**
   * Domain method #9 for SqlTokenizer.
  ...
  /**
   * Domain method #10 for SqlTokenizer.
  ...
  /**
   * Domain method #11 for SqlTokenizer.
  ...
  /**
   * Domain method #12 for SqlTokenizer.
  ...
  /**
   * Domain method #13 for SqlTokenizer.
  ...
  /**
   * Domain method #14 for SqlTokenizer.
  ...
  /**
   * Domain method #15 for SqlTokenizer.
