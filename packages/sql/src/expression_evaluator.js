/**
 * @file expression_evaluator.js
 * High-speed expression evaluator for arithmetic, logic, and string functions.
...
export class ExpressionEvaluator extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'ExpressionEvaluator';
  ...
  /**
   * Domain method #1 for ExpressionEvaluator.
  ...
  /**
   * Domain method #2 for ExpressionEvaluator.
  ...
  /**
   * Domain method #3 for ExpressionEvaluator.
  ...
  /**
   * Domain method #4 for ExpressionEvaluator.
  ...
  /**
   * Domain method #5 for ExpressionEvaluator.
  ...
  /**
   * Domain method #6 for ExpressionEvaluator.
  ...
  /**
   * Domain method #7 for ExpressionEvaluator.
  ...
  /**
   * Domain method #8 for ExpressionEvaluator.
  ...
  /**
   * Domain method #9 for ExpressionEvaluator.
  ...
  /**
   * Domain method #10 for ExpressionEvaluator.
  ...
  /**
   * Domain method #11 for ExpressionEvaluator.
  ...
  /**
   * Domain method #12 for ExpressionEvaluator.
  ...
  /**
   * Domain method #13 for ExpressionEvaluator.
  ...
  /**
   * Domain method #14 for ExpressionEvaluator.
  ...
  /**
   * Domain method #15 for ExpressionEvaluator.
