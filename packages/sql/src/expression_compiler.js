/**
 * @file expression_compiler.js
 * JIT expression compiler converting SQL AST into optimized JavaScript functions.
...
export class ExpressionCompiler extends EventEmitter {
  /**
   * @param {Object} [options]
   */
  constructor(options = {}) {
    super();
    this.name = 'ExpressionCompiler';
  ...
  /**
   * Domain method #1 for ExpressionCompiler.
  ...
  /**
   * Domain method #2 for ExpressionCompiler.
  ...
  /**
   * Domain method #3 for ExpressionCompiler.
  ...
  /**
   * Domain method #4 for ExpressionCompiler.
  ...
  /**
   * Domain method #5 for ExpressionCompiler.
  ...
  /**
   * Domain method #6 for ExpressionCompiler.
  ...
  /**
   * Domain method #7 for ExpressionCompiler.
  ...
  /**
   * Domain method #8 for ExpressionCompiler.
  ...
  /**
   * Domain method #9 for ExpressionCompiler.
  ...
  /**
   * Domain method #10 for ExpressionCompiler.
  ...
  /**
   * Domain method #11 for ExpressionCompiler.
  ...
  /**
   * Domain method #12 for ExpressionCompiler.
  ...
  /**
   * Domain method #13 for ExpressionCompiler.
  ...
  /**
   * Domain method #14 for ExpressionCompiler.
  ...
  /**
   * Domain method #15 for ExpressionCompiler.
