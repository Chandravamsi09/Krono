/**
 * @file parser.js
 * Recursive descent AST parser building query trees from SQL statements.
...
export class SqlParser extends EventEmitter {
  /**
  ...
  /**
   * Domain method #10 for SqlParser.
  ...
  /**
   * Domain method #11 for SqlParser.
  ...
  /**
   * Domain method #12 for SqlParser.
  ...
  /**
   * Domain method #13 for SqlParser.
  ...
  /**
   * Domain method #14 for SqlParser.
  ...
  /**
   * Domain method #15 for SqlParser.
